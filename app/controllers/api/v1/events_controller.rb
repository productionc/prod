class Api::V1::EventsController < Api::V1::BaseController
  ...
  def events_list
    ...
    render json: paginated_events, each_serializer: Api::V1::Serializers::EventSerializer, root: 'events', meta: {status: code, message: message, has_more: has_more, total_entries: total_entries}
  end
